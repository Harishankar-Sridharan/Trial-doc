...
![](<../.gitbook/assets/SubcontractorManagement_AssigningMissionsToSubcontractor_002_EN.png>)

4. The selected missions will now be assigned to the chosen subcontractor.

![](<../.gitbook/assets/SubcontractorManagement_AssigningMissionsToSubcontractor_003_EN.png>)
...
![](<../.gitbook/assets/SubcontractorManagement_AssigningMissionsToSubcontractor_004_EN.png>)

5. The mission tab will now show only the missions allocated to the chosen subcontractor.

![](<../.gitbook/assets/SubcontractorManagement_AssigningMissionsToSubcontractor_005_EN.png>)
