...
- **Shuttle**: Tap this menu option to select your desired shuttle route.
  ...
  ![Shuttle Menu – Screen displaying shuttle route selections.](../images/shuttlemanagement-shuttlemanagement_timestamp_0_to_18.png "Shuttle Menu – Screen displaying shuttle route selections.")

- **Apply**: Tap this option to confirm your selected shuttle.

  ![Apply Button – Confirms and registers the chosen shuttle route.](../images/shuttlemanagement-shuttlemanagement_timestamp_0_to_28.png "Apply Button – Confirms and registers the chosen shuttle route.")

- **Start**: Press this button to initialize the parcel scanner.

  ![Start Button – Launches the camera-based parcel scanner.](../images/shuttlemanagement-shuttlemanagement_timestamp_0_to_36.png "Start Button – Launches the camera-based parcel scanner.")

- **Scan**: Frame the barcode within the viewfinder to record the parcel.

  ![Scan Interface – Camera view for scanning package barcodes.](../images/shuttlemanagement-shuttlemanagement_timestamp_0_to_45.png "Scan Interface – Camera view for scanning package barcodes.")
...
3. Select your shuttle from the available list.
   ...
   ![Shuttle List – Selecting the shuttle from the route menu.](../images/shuttlemanagement-shuttlemanagement_timestamp_0_to_18_to_0_to_23.gif "Shuttle List – Selecting the shuttle from the route menu.")

4. Tap on **apply** to save your selection.

   ![Apply Action – Pressing apply to lock in your shuttle selection.](../images/shuttlemanagement-shuttlemanagement_timestamp_0_to_23_to_0_to_28.gif "Apply Action – Pressing apply to lock in your shuttle selection.")

5. Tap the selected **shuttle** once more.

   ![Select Shuttle – Tapping the shuttle to load details.](../images/shuttlemanagement-shuttlemanagement_timestamp_0_to_28_to_0_to_32.gif "Select Shuttle – Tapping the shuttle to load details.")

6. Tap on **start** to launch the scanner.

   ![Start Scan – Initializing the scan engine.](../images/shuttlemanagement-shuttlemanagement_timestamp_0_to_32_to_0_to_36.gif "Start Scan – Initializing the scan engine.")

7. Scan the parcel barcode.

   ![Scanning – Carrying out the parcel barcode scan.](../images/shuttlemanagement-shuttlemanagement_timestamp_0_to_36_to_0_to_45.gif "Scanning – Carrying out the parcel barcode scan.")
...
- **Resolution**: Verify that the package belongs to the correct site before scanning again.
  ...
  ![Error Pop-up – Warning showing that the scanned parcel is unexpected.](../images/shuttlemanagement-shuttlemanagement_timestamp_0_to_56.png "Error Pop-up – Warning showing that the scanned parcel is unexpected.")
